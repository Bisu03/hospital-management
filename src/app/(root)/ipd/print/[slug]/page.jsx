...
const IpdPrint = () => {
  ...
  const { data, error, isLoading, refetch } = useQuery({
    queryKey: ["ipddetails", slug], // Unique query key
        ...
        <div className=" mx-auto bg-white p-6 rounded-lg font-bold">
          <div className="flex justify-between text-sm font-semibold mb-4">
            <div className="flex gap-2 items-center">
              ...
              <input
                ...
                className="border-b border-black w-24 text-center"
                readOnly
              />
            </div>
            <div className="flex gap-2 items-center">
          ...
          <div className="text-sm space-y-2 border-b pb-4">
            <div className="flex justify-between">
              ...
              <input
                ...
                className="border-b border-black flex-1 ml-2"
                readOnly
              />
            </div>
            <div className="flex justify-between">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="border-b border-black w-12"
                  readOnly
                />
              </div>
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="border-b border-black w-16"
                  readOnly
                />
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="text-sm space-y-2 border-b pb-4 pt-4">
            <div className="flex justify-between">
              ...
              <input
                type="text"
                value={formData?.patient?.guardian_name}
                className="border-b border-black flex-1"
                readOnly
              />
            </div>
          ...
          <div className="text-sm border-b">
            <div className="flex justify-between">
              ...
              <input
                type="text"
                value={formData?.consultant?.drname}
                className="border-b border-black flex-1"
                readOnly
              />
            </div>
            ...
            <table className="w-full text-[10px] print:text-[8px]">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="p-0.5 text-left border">Bed Number</th>
                </tr>
              </thead>
              <tbody>
                {data?.billdata?.acomodation_cart?.items?.map((item, index) => (
                  <tr key={index}>
                    <td className="p-0.5 border">{item.bed_category}</td>
                    <td className="p-0.5 border">{item.bed_number}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="text-sm text-left text-red-600 font-semibold pt-4 border-b pb-4">
            <p>
              WITH BEST OF MY KNOWLEDGE THE ABOVE STATEMENTS ARE TRUE. I MUST
              OBEY THE RULES & REGULATIONS OF THIS NURSING HOME AND PAY ALL
              EXPENSES BEFORE DISCHARGE.
            </p>
            <p className="mt-2">
              1. I HEREBY CONSENT TO THE TREATMENT AND PROCEDURES ADVISED BY THE
              HOSPITAL AUTHORITIES.
            </p>
            <p className="mt-1">
              2. I UNDERSTAND THAT THE HOSPITAL IS NOT RESPONSIBLE FOR THE LOSS
              OF PERSONAL BELONGINGS.
            </p>
            <p className="mt-1">
              3. I AGREE TO FOLLOW ALL MEDICAL ADVICE AND MEDICATION SCHEDULES
              PRESCRIBED BY THE TREATING PHYSICIAN.
            </p>
            <p className="mt-1">
              4. I ACKNOWLEDGE THAT THE HOSPITAL SHALL NOT BE LIABLE FOR ANY
              UNFORESEEN COMPLICATIONS DURING TREATMENT.
            </p>
            <p className="mt-1">
              5. I UNDERSTAND THAT ALL MEDICAL RECORDS WILL BE MAINTAINED AS PER
              HOSPITAL POLICY.
            </p>
            <p className="mt-1">
              6. I AGREE TO INFORM THE HOSPITAL STAFF IMMEDIATELY ABOUT ANY
          ...
          <div className="text-left uppercase">
            <p>
              ADMISSION FEE OF ₹{formData?.admission_charge} HAS BEEN PAID IN{" "}
              {formData?.paidby}
            </p>
          </div>
          ...
          <div className="flex w-full justify-between">
            <div className="flex text-sm pt-10">
              <span>SIGNATURE OF PATIENT PARTY</span>
              <input
                type="text"
